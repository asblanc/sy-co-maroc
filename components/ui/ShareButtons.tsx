...
/** Re-share buttons for an article (LinkedIn, X, Facebook, WhatsApp, copy). */
export function ShareButtons({ url, title }: { url: string; title: string }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <span className="font-heading text-sm font-bold uppercase tracking-wide text-ink/60">
        Partager
      </span>
      {links.map((l) => {
        const Icon = l.icon;
        return (
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-teal/20 text-teal transition-colors hover:bg-teal hover:text-white"
          >
